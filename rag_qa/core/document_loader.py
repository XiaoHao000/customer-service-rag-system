...
from rag_qa.text_spliter import AliTextSplitter, ChineseRecursiveTextSplitter
...
def load_documents_from_directory(directory_path):
    ...
    # 从目录名提取来源标识（如 "enterprise_it_data" -> "enterprise_it"）
...
if __name__ == '__main__':
    chunks = process_documents(
        os.path.join(os.path.dirname(__file__), '..', 'data'),  # 使用项目相对路径
