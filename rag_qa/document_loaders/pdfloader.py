...
from rag_qa.document_loaders.docloader import get_ocr
...
if __name__ == '__main__':
    sample_pdf = os.path.join(os.path.dirname(__file__), '..', 'data', 'samples', 'LLM基础知识.pdf')
    pdf_loader = OCRPDFLoader(file_path=sample_pdf)  #
    doc = pdf_loader.load()
